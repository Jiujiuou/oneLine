...
- Store 状态管理（gameStore, messageStore, themeStore, soundStore）
- Hooks 工具函数（useTipsPosition, useKeyboardEvents, useAutoFocus 等）
- Utils 工具函数
- Constants 常量定义
- 主题切换功能
...
- 障碍物生成器（`obstacleGenerator.js`）
- 支持障碍物参数

### 阶段 3: 可视化棋盘与交互 ✅

- GridBoard 组件完整实现
- Cell 组件（支持普通、提示、错误、障碍状态）
- 鼠标拖拽连线
- 回撤功能
- 错误提示（起点错误、顺序错误）
- 障碍物渲染支持
